                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="padding:0px 20px 0px 0px;vertical-align:top;width:101px">
                                                <a href="https://stackedfarm.com/" style="color:rgb(77,77,77);font-size:10px;line-height:13px;letter-spacing:0.2px" target="_blank">stackedfarm.com</a>&nbsp;
                                            </td>
                                            <td style="padding:0px 20px 0px 0px;vertical-align:top;width:63px">
                                                <a href="https://www.linkedin.com/company/stackedfarm/" style="color:rgb(77,77,77);font-size:10px;line-height:13px;letter-spacing:0.2px" target="_blank">LinkedIn</a>&nbsp;
                                            </td>
                                            <td style="padding:0px;vertical-align:top">
                                                <a href="https://www.instagram.com/stackedfarm/" style="color:rgb(77,77,77);font-size:10px;line-height:13px;letter-spacing:0.2px" target="_blank">Instagram</a>&nbsp;
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
