  ...
  const phoneHtml = `<tr>
    <td valign="top" style="padding:0px 0px 3px;vertical-align:top">
      <div style="color:rgb(0,0,0);font-size:12px;letter-spacing:0.2px;white-space:nowrap;line-height:normal;margin:0px;padding:0px;">
        <span style="display:inline-block;min-width:92px;">${phoneFormatted}</span><span style="display:inline-block;width:40px;text-align:center;">${phone && phone2 ? '|' : ''}</span><span style="display:inline-block;">${phone2Formatted}</span>
      </div>
    </td>
  </tr>`
